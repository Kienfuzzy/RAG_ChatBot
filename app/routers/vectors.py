...
async def search_vectors(request: VectorSearchRequest, qdrant_service = Depends(get_qdrant_service)):
...
async def create_collection(collection_name: str, vector_size: int = 1536, qdrant_service = Depends(get_qdrant_service)):
...
async def delete_collection(collection_name: str, qdrant_service = Depends(get_qdrant_service)):
